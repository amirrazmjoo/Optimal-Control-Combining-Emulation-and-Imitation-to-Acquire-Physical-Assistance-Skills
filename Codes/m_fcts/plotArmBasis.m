...
for i=1:5
	if facecol==[1,1,1]
		h = [h patch([x2(1,i) x3(1,i)], [x2(2,i) x3(2,i)], [x2(3,i) x3(3,i)], edgecol,'edgecolor',edgecol,'linewidth',3,'edgealpha',alpha,'facealpha',alpha)]; 
	else
		h = [h patch([x2(1,i) x3(1,i)], [x2(2,i) x3(2,i)], [x2(3,i) x3(3,i)], facecol,'edgecolor',facecol,'linewidth',3,'edgealpha',alpha,'facealpha',alpha)]; 
	end
end
